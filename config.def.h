...
static const char *colors[][3]		= {
	/*               fg		bg		border   */
	[SchemeNorm] = { fg_col,	green_col,	bg_col},
	[SchemeSel]  = { fg_col,	bg_col,		red_col},
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", bg_col, "-nf", fg_col, "-sb", green_col, "-sf", fg_col, NULL };
